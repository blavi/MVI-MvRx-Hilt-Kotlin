...
import com.softvision.data.network.model.base.ItemResponse
...
sealed class Item(@Json(name="media_type") val type: ItemType? = null):
    ItemResponse<ItemEntity, String, ItemDetails>
...
data class PersonResponse(
    ...
    override fun mapToRoomEntity(categories: List<String>): ItemEntity {
...
//
//sealed class TMDBItemTypeResponse {
//    @JsonClass(generateAdapter = true)
//    data class TMDBMovieTypeResponse(
//        @Json(name = "id") val id : Int,
//        @Json(name = "adult") val adult : Boolean,
//        @Json(name = "backdrop_path") val backdrop_path : String?,
//        @Json(name = "genre_ids") val genre_ids : List<Int>,
...
//        @Json(name = "vote_count") val vote_count : Int,
//        @Json(name = "media_type") val media_type : String
//    ) : TMDBItemTypeResponse(), ItemDomainMapper<TMDBItemDetails> {
//
...
//
//    @JsonClass(generateAdapter = true)
//    data class TMDBTVShowTypeResponse(
//        @Json(name = "id") val id : Int,
//        @Json(name = "backdrop_path") val backdrop_path : String?,
//        @Json(name = "genre_ids") val genre_ids : List<Int>,
//        @Json(name = "origin_country") val origin_country: List<String>,
...
//
//    @JsonClass(generateAdapter = true)
//    data class TMDBPersonTypeResponse(
//        @Json(name = "id") val id : Int,
//        @Json(name = "profile_path") val profile_path : String?,
//        @Json(name = "adult") val adult : Boolean,
//        @Json(name = "media_type") val media_type : String,
//        @Json(name = "known_for") val known_for : List<TMDBItemTypeResponse>,
//        @Json(name = "known_for_department") val known_for_department : String,
//        @Json(name = "name") val name : String,
//        @Json(name = "gender") val gender : Int,
//        @Json(name = "popularity") val popularity : Double
//    ) : TMDBItemTypeResponse(), ItemDomainMapper<TMDBItemDetails> {
//        override fun mapToDomainModel(): TMDBPersonDetails {
//            return TMDBPersonDetails(
//                id, profile_path, adult, emptyList(), known_for_department,
//                name, gender, popularity
//            )
//        }
//    }
